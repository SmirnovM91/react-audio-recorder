...
import d, { useState as r, useRef as v, useCallback as b, useEffect as k } from "react";
const A = () => {
  const [w, N] = r(!1), [M, g] = r(!1), [D, I] = r(0), i = v(), [t, j] = r(), [z, y] = r(), n = () => {
    const e = setInterval(() => {
      I((c) => c + 1);
    }, 1e3);
    j(e);
  }, m = () => {
    t != null && clearInterval(t), j(void 0);
  };
  return {
    startRecording: b(() => {
      t == null && navigator.mediaDevices.getUserMedia({ audio: !0 }).then((e) => {
        var u, L, C;
        const c = [], o = MediaRecorder.isTypeSupported("audio/webm") ? "audio/webm" : "audio/mp4";
        console.log(o), i.current = new MediaRecorder(e, {
          mimeType: o
        }), (u = i.current) == null || u.addEventListener("dataavailable", (a) => {
          a.data.size > 0 && c.push(a.data);
        }), (L = i.current) == null || L.addEventListener("stop", () => {
          var a;
          y(
            new Blob(c, { type: (a = i.current) == null ? void 0 : a.mimeType })
          ), i.current = null;
        }), (C = i.current) == null || C.start(), n(), N(!0);
      }).catch((e) => console.log(e));
    }, [t]),
    stopRecording: () => {
      var e;
      (e = i == null ? void 0 : i.current) == null || e.stop(), m(), I(0), N(!1), g(!1);
    },
    togglePauseResume: () => {
      var e, c;
      M ? (g(!1), (e = i == null ? void 0 : i.current) == null || e.resume(), n()) : (g(!0), m(), (c = i == null ? void 0 : i.current) == null || c.pause());
    },
    recordingBlob: z,
    isRecording: w,
    isPaused: M,
...
const Z = ({
  ...
  const {
    ...
    isPaused: j,
    recordingTime: z
  } = N != null ? N : A(), [y, n] = r(!1), m = (C = !0) => {
    n(C), D();
  };
  return k(() => {
    (y || N) && i != null && w != null && w(i);
  }, [i]), t ? /* @__PURE__ */ d.createElement("div", {
    className: `audio-recorder ${t ? "recording" : ""} ${(T = M == null ? void 0 : M.AudioRecorderClass) != null ? T : ""}`,
    ...
    className: `audio-recorder-timer ${t ? "" : "display-none"} ${(o = M == null ? void 0 : M.AudioRecorderTimerClass) != null ? o : ""}`,
    "data-testid": "ar_timer"
  }, Math.floor(z / 60), ":", String(z % 60).padStart(2, "0")), /* @__PURE__ */ d.createElement("img", {
    src: j ? O : Y,
    className: `audio-recorder-options ${t ? "" : "display-none"} ${(u = M == null ? void 0 : M.AudioRecorderPauseResumeClass) != null ? u : ""}`,
    onClick: I,
    title: j ? "Resume recording" : "Pause recording",
    "data-testid": "ar_pause"
  }), /* @__PURE__ */ d.createElement("img", {
    src: x,
    className: `audio-recorder-options ${t ? "" : "display-none"} ${(L = M == null ? void 0 : M.AudioRecorderDiscardClass) != null ? L : ""}`,
    onClick: () => m(!0),
    title: "Discard Recording",
    "data-testid": "ar_cancel"
  })) : /* @__PURE__ */ d.createElement("div", {
    className: `audio-recorder-mic-button ${(S = M == null ? void 0 : M.AudioRecorderClass) != null ? S : ""}`,
    onClick: g
  }, /* @__PURE__ */ d.createElement("img", {
    src: l,
