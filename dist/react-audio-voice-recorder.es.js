...
import i, { useState as j, useRef as s, useCallback as Y, useEffect as Q } from "react";
const R = (g = "default") => {
  const [D, M] = j(!1), [y, u] = j(!1), [n, T] = j(0), I = s(), [N, c] = j(), [A, z] = j(), [O, r] = j(), a = () => {
    const e = setInterval(() => {
      T((t) => t + 1);
    }, 1e3);
    c(e);
  ...
  return {
    startRecording: Y(
      (e) => {
        N == null && navigator.mediaDevices.getUserMedia({ audio: { deviceId: g } }).then((t) => {
          var x, k, E;
          const m = [], C = MediaRecorder.isTypeSupported("audio/webm") ? "audio/webm" : "audio/mp4";
          r(t), I.current = new MediaRecorder(t, {
            mimeType: C
          }), (x = I.current) == null || x.addEventListener("dataavailable", (o) => {
            o.data.size > 0 && m.push(o.data);
          }), (k = I.current) == null || k.addEventListener("stop", () => {
            var o;
            z(
              new Blob(m, { type: (o = I.current) == null ? void 0 : o.mimeType })
            ), I.current = null;
          }), (E = I.current) == null || E.start(), a(), M(!0);
        }).catch((t) => {
          e && e(t);
        });
      },
    ...
    stopRecording: () => {
      var e;
      (e = I == null ? void 0 : I.current) == null || e.stop(), d(), T(0), M(!1), u(!1), r(void 0);
    },
    togglePauseResume: () => {
      var e, t;
      y ? (u(!1), (e = I == null ? void 0 : I.current) == null || e.resume(), a()) : (u(!0), d(), (t = I == null ? void 0 : I.current) == null || t.pause());
    },
    recordingBlob: A,
    isRecording: D,
    isPaused: y,
...
const p = ({
  ...
  const {
    ...
    isRecording: N,
    recordingTime: c
  } = D != null ? D : R(), [A, z] = j(!1), O = (t = !0) => {
    z(t), T();
  }, r = () => {
    u == null || u(), n(y);
  };
  return Q(() => {
    (A || D) && I != null && g != null && g(I);
    ...
    src: v,
    className: `audio-recorder-button ${(L = M == null ? void 0 : M.AudioRecorderDiscardClass) != null ? L : ""}`,
    onClick: () => O(!0),
    "data-testid": "ar_stop",
    ...
    className: `audio-recorder-timer ${N ? "" : "display-none"} ${(e = M == null ? void 0 : M.AudioRecorderTimerClass) != null ? e : ""}`,
    ...
    className: `audio-recorder-button-button ${(a = M == null ? void 0 : M.AudioRecorderClass) != null ? a : ""}`,
    onClick: r
  }, /* @__PURE__ */ i.createElement("img", {
    src: b,
    className: `audio-recorder-button ${(d = M == null ? void 0 : M.AudioRecorderStartSaveClass) != null ? d : ""}`,
    "data-testid": "ar_mic",
    title: "start recording"
  }));
};
