...
import d, { useState as L, useRef as l, useCallback as v, useEffect as k } from "react";
const A = () => {
  const [w, N] = L(!1), [M, j] = L(!1), [D, I] = L(0), i = l(), [c, u] = L(), [z, m] = L(), n = () => {
    const t = setInterval(() => {
      I((e) => e + 1);
    }, 1e3);
    u(t);
  }, C = () => {
    c != null && clearInterval(c), u(void 0);
  };
  return {
    startRecording: v(() => {
      c == null && navigator.mediaDevices.getUserMedia({ audio: !0 }).then((t) => {
        ...
        N(!0);
        const e = [];
        i.current = new MediaRecorder(t), (g = i.current) == null || g.addEventListener("dataavailable", (r) => {
          r.data.size > 0 && e.push(r.data);
        }), (o = i.current) == null || o.addEventListener("stop", () => {
          var r;
          m(
            new Blob(e, { type: (r = i.current) == null ? void 0 : r.mimeType })
          ), i.current = null;
    ...
    stopRecording: () => {
      var t, e;
      (t = i == null ? void 0 : i.current) == null || t.stop(), (e = i == null ? void 0 : i.current) == null || e.stream.getTracks().forEach((g) => g.stop()), C(), I(0), N(!1), j(!1);
    },
    togglePauseResume: () => {
      var t, e;
...
const B = ({
  ...
  return k(() => {
    ...
    className: `audio-recorder-timer ${c ? "" : "display-none"} ${(g = M == null ? void 0 : M.AudioRecorderTimerClass) != null ? g : ""}`,
