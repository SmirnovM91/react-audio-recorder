...
import N, { useState as D, useRef as b, useCallback as C, useEffect as s } from "react";
const Y = (g = "default") => {
  const [j, M] = D(!1), [y, u] = D(!1), [n, o] = D(0), I = b(), [i, c] = D(), [A, z] = D(), T = () => {
    const e = setInterval(() => {
      o((t) => t + 1);
    }, 1e3);
    c(e);
  ...
  return {
    startRecording: C(
      (e) => {
        i == null && navigator.mediaDevices.getUserMedia({ audio: { deviceId: g } }).then((t) => {
          var m, x, k;
...
const U = ({
  ...
  return s(() => {
  ...
  }, [I]), i ? /* @__PURE__ */ N.createElement("div", {
    ...
    className: `audio-recorder-timer ${i ? "" : "display-none"} ${(a = M == null ? void 0 : M.AudioRecorderTimerClass) != null ? a : ""}`,
    "data-testid": "ar_timer"
  }, /* @__PURE__ */ N.createElement("div", {
    className: "audio-recorder-timer-dot"
  }), /* @__PURE__ */ N.createElement("div", null, Math.floor(c / 60), ":", String(c % 60).padStart(2, "0")))) : /* @__PURE__ */ N.createElement("div", {
