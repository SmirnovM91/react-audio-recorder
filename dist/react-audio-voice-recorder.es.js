...
import d, { useState as j, useRef as l, useCallback as v, useEffect as b } from "react";
const k = () => {
  const [w, N] = j(!1), [M, r] = j(!1), [n, I] = j(0), i = l(), [t, u] = j(), [z, D] = j(), m = () => {
    const e = setInterval(() => {
      I((c) => c + 1);
    }, 1e3);
    u(e);
  }, C = () => {
    t != null && clearInterval(t), u(void 0);
  };
  return {
    startRecording: v(() => {
      t == null && navigator.mediaDevices.getUserMedia({ audio: !0 }).then((e) => {
        ...
        }), (o = i.current) == null || o.addEventListener("dataavailable", (g) => {
        ...
        }), (a = i.current) == null || a.start(), m(), N(!0);
      }).catch((e) => console.log(e));
    }, [t]),
    stopRecording: () => {
      var e;
      (e = i == null ? void 0 : i.current) == null || e.stop(), C(), I(0), N(!1), r(!1);
    },
    togglePauseResume: () => {
      var e, c;
      M ? (r(!1), (e = i == null ? void 0 : i.current) == null || e.resume(), m()) : (r(!0), C(), (c = i == null ? void 0 : i.current) == null || c.pause());
    },
    recordingBlob: z,
    isRecording: w,
    isPaused: M,
...
const B = ({
  ...
  return b(() => {
    ...
    src: u ? Y : A,
    className: `audio-recorder-options ${t ? "" : "display-none"} ${(L = M == null ? void 0 : M.AudioRecorderPauseResumeClass) != null ? L : ""}`,
    onClick: I,
