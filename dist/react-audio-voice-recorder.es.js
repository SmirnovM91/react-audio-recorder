...
const Y = (d = "default") => {
  const [j, M] = D(!1), [y, u] = D(!1), [n, o] = D(0), I = b(), [N, g] = D(), [A, z] = D(), T = () => {
    const e = setInterval(() => {
      o((t) => t + 1);
    }, 1e3);
    g(e);
  ...
  return {
    startRecording: C(
      (e) => {
        N == null && navigator.mediaDevices.getUserMedia({ audio: { deviceId: d } }).then((t) => {
          var m, x, k;
          const r = [], l = MediaRecorder.isTypeSupported("audio/webm") ? "audio/webm" : "audio/mp4";
          I.current = new MediaRecorder(t, {
            mimeType: l
          }), (m = I.current) == null || m.addEventListener("dataavailable", (a) => {
    ...
    stopRecording: () => {
      var e;
      (e = I == null ? void 0 : I.current) == null || e.stop(), c(), o(0), M(!1), u(!1);
    },
    togglePauseResume: () => {
      var e, t;
      y ? (u(!1), (e = I == null ? void 0 : I.current) == null || e.resume(), T()) : (u(!0), c(), (t = I == null ? void 0 : I.current) == null || t.pause());
    },
    recordingBlob: A,
    isRecording: j,
    isPaused: y,
...
const v = ({
  ...
  return s(() => {
    ...
    className: `audio-recorder-timer ${N ? "" : "display-none"} ${(r = M == null ? void 0 : M.AudioRecorderTimerClass) != null ? r : ""}`,
    "data-testid": "ar_timer"
  }, /* @__PURE__ */ i.createElement("div", {
    className: "audio-recorder-timer-dot"
  }), /* @__PURE__ */ i.createElement("div", null, Math.floor(g / 60), ":", String(g % 60).padStart(2, "0")))) : /* @__PURE__ */ i.createElement("div", {
